...
class ZuulMessageImplTest {
  ...
  void testResettingBodyReaderIndex() {
    ...
    // replicate what happens in nettys tls channel writer which moves the reader index on the
    // contained ByteBuf
    ...
    assertArrayEquals(
        new byte[0], msg.getBody(), "body should be empty as readerIndex at end of buffers");
    msg.resetBodyReader();
