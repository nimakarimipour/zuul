...
public class Http2MetricsChannelHandlers {
    ...
    public Http2MetricsChannelHandlers(@Nullable Registry registry, String metricPrefix, String metricId) {
        super();
    ...
    protected static void incrementErrorCounter(@Nullable Registry registry, String counterName, String metricId, Http2Exception h2e) {
    ...
    protected static void incrementCounter(@Nullable Registry registry, String counterName, String metricId, Http2Frame frame) {
        long errorCode;
    ...
    private static class Inbound extends ChannelInboundHandlerAdapter {
        ...
        public Inbound(@Nullable Registry registry, String metricId, String metricPrefix) {
    ...
    private static class Outbound extends ChannelOutboundHandlerAdapter {
        ...
        public Outbound(@Nullable Registry registry, String metricId, String metricPrefix) {
            this.registry = registry;
            this.metricId = metricId;
