 ...
 *
 * <p>Author: Arthur Gonigberg Date: September 20, 2016
 */
public class InstrumentedResourceLeakDetector<T> extends ResourceLeakDetector<T> {
  ...
  /**
   * This private field in the superclass needs to be reset so that we can continue reporting leaks
   * even if they're duplicates. This is ugly but ideally should not be called frequently (or at
   * all).
   */
