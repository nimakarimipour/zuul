...
public class Http1ConnectionCloseHandler extends ChannelDuplexHandler {
  ...
  protected void closeChannel(
      ChannelHandlerContext ctx, ConnectionCloseType evt, ChannelPromise promise) {
    switch (evt) {
  ...
  protected void gracefully(ChannelHandlerContext ctx, ChannelPromise promise) {
    ...
    if (channel.isActive()) {
      ...
      // In gracefulCloseDelay secs time, go ahead and close the connection if it hasn't already
      // been.
