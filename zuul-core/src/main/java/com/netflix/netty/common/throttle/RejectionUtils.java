...
public final class RejectionUtils {
     ...
     */
    public static void rejectByClosingConnection(ChannelHandlerContext ctx, StatusCategory nfStatus, String reason, @Nullable HttpRequest request, @Nullable Integer injectedLatencyMillis) {
     ...
     */
    public static void sendRejectionResponse(ChannelHandlerContext ctx, StatusCategory nfStatus, String reason, @Nullable HttpRequest request, Integer injectedLatencyMillis, HttpResponseStatus rejectedCode, String rejectedBody, Map<String, String> rejectionHeaders) {
     ...
     * @param rejectionHeaders additional HTTP headers to add to the rejection response
     */
    public static void handleRejection(ChannelHandlerContext ctx, Object msg, RejectionType rejectionType, StatusCategory nfStatus, String reason, Integer injectedLatencyMillis, HttpResponseStatus rejectedCode, String rejectedBody, Map<String, String> rejectionHeaders) throws Exception {
     ...
     * @param rejectedBody the HTTP body to be sent back.  It is assumed to be of type text/plain.
     */
    public static void reject(ChannelHandlerContext ctx, RejectionType rejectionType, StatusCategory nfStatus, String reason, HttpRequest request, Integer injectedLatencyMillis, HttpResponseStatus rejectedCode, String rejectedBody) {
        reject(ctx, rejectionType, nfStatus, reason, request, injectedLatencyMillis, rejectedCode, rejectedBody, Collections.emptyMap());
    }
     ...
     * @param rejectionHeaders additional HTTP headers to add to the rejection response
     */
    public static void reject(ChannelHandlerContext ctx, RejectionType rejectionType, StatusCategory nfStatus, String reason, @Nullable HttpRequest request, Integer injectedLatencyMillis, HttpResponseStatus rejectedCode, String rejectedBody, Map<String, String> rejectionHeaders) {
        switch(rejectionType) {
            case REJECT:
                sendRejectionResponse(ctx, nfStatus, reason, request, injectedLatencyMillis, rejectedCode, rejectedBody, rejectionHeaders);
                return;
            case CLOSE:
    ...
    private static void notifyHandlers(ChannelHandlerContext ctx, StatusCategory nfStatus, HttpResponseStatus status, String reason, @Nullable HttpRequest request) {
