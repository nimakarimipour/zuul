...
public class DynamicHttp2FrameLogger extends Http2FrameLogger {
  public static final AttributeKey<Object> ATTR_ENABLE =
      AttributeKey.valueOf("http2.frame.logger.enabled");
  private static final int BUFFER_LENGTH_THRESHOLD = 64;
  private static final DynamicStringSetProperty FRAMES_TO_LOG =
  ...
  public void logHeaders(
    ...
    if (enabled()) {
      log(
          ...
          "HEADERS",
          ctx,
          "streamId=%d, headers=%s, endStream=%b",
          streamId,
          headers,
          endStream);
    }
  ...
  public void logRstStream(
      Direction direction, ChannelHandlerContext ctx, int streamId, long errorCode) {
    if (enabled()) {
  ...
  private void log(
      Direction direction, String frame, ChannelHandlerContext ctx, String format, Object... args) {
