...
public final class HttpServerLifecycleChannelHandler extends HttpLifecycleChannelHandler {
  public static final class HttpServerLifecycleInboundChannelHandler
  ...
  public static final class HttpServerLifecycleOutboundChannelHandler
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise)
      ...
      try {
        ...
        if (msg instanceof LastHttpContent) {
          ...
          if (msg instanceof HttpResponse) {
            // Handle case of 100 CONTINUE, where server sends an initial 100 status response to
            // indicate to client
            // that it can continue sending the initial request body.
            // ie. in this case we don't want to consider the state to be COMPLETE until after the
            // 2nd response.
