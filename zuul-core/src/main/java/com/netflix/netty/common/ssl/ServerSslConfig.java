...
public class ServerSslConfig {
    ...
    private static final DynamicLongProperty // 18 hours
    // 18 hours
    DEFAULT_SESSION_TIMEOUT = new DynamicLongProperty("server.ssl.session.timeout", (18 * 60));
    ...
    public ServerSslConfig(String[] protocols, String[] ciphers, File certChainFile, File keyFile, ClientAuth clientAuth) {
        this(protocols, ciphers, certChainFile, keyFile, clientAuth, null, (File) null, true);
    }

    public ServerSslConfig(String[] protocols, String[] ciphers, @Nullable File certChainFile, @Nullable File keyFile, ClientAuth clientAuth, @Nullable File clientAuthTrustStoreFile, @Nullable File clientAuthTrustStorePasswordFile, boolean sessionTicketsEnabled) {
    ...
    public ServerSslConfig(String[] protocols, String[] ciphers, File certChainFile, File keyFile, ClientAuth clientAuth, File clientAuthTrustStoreFile, String clientAuthTrustStorePassword, boolean sessionTicketsEnabled) {
        this.protocols = protocols;
    ...
    public String toString() {
        return "ServerSslConfig{" + "protocols=" + Arrays.toString(protocols) + ", ciphers=" + ciphers + ", certChainFile=" + certChainFile + ", keyFile=" + keyFile + ", clientAuth=" + clientAuth + ", clientAuthTrustStoreFile=" + clientAuthTrustStoreFile + ", sessionTimeout=" + sessionTimeout + ", sessionTicketsEnabled=" + sessionTicketsEnabled + '}';
    }
}
