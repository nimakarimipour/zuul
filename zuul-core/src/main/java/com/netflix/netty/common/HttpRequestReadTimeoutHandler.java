...
public class HttpRequestReadTimeoutHandler extends ChannelInboundHandlerAdapter {
    ...
    protected HttpRequestReadTimeoutHandler(long timeout, TimeUnit unit, @Nullable Counter httpRequestReadTimeoutCounter) {
     ...
     * correct name.
     */
    public static void addLast(ChannelPipeline pipeline, long timeout, TimeUnit unit, @Nullable Counter httpRequestReadTimeoutCounter) {
