...
/** User: michaels@netflix.com Date: 2/8/17 Time: 6:21 PM */
public class CommonChannelConfigKeys {
  ...
  public static final ChannelConfigKey<StripUntrustedProxyHeadersHandler.AllowWhen>
      allowProxyHeadersWhen =
          new ChannelConfigKey<>(
              "allowProxyHeadersWhen", StripUntrustedProxyHeadersHandler.AllowWhen.ALWAYS);
  ...
  public static final ChannelConfigKey<Integer> idleTimeout =
      new ChannelConfigKey<>("idleTimeout", 65000);

  public static final ChannelConfigKey<ServerTimeout> serverTimeout =
      new ChannelConfigKey<>("serverTimeout");
  ...
  public static final ChannelConfigKey<Integer> maxConnections =
      new ChannelConfigKey<>("maxConnections", 20000);
  ...
  public static final ChannelConfigKey<ServerSslConfig> serverSslConfig =
      new ChannelConfigKey<>("serverSslConfig");
  ...
  public static final ChannelConfigKey<Integer> connCloseDelay =
      new ChannelConfigKey<>("connCloseDelay", 10);
