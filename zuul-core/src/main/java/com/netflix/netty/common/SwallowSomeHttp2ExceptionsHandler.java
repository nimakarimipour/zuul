...
public class SwallowSomeHttp2ExceptionsHandler extends ChannelOutboundHandlerAdapter {
    ...
    public SwallowSomeHttp2ExceptionsHandler(@Nullable Registry registry) {
    ...
    private void incrementExceptionCounter(Throwable throwable) {
        registry.counter("server.connection.pipeline.exception", "id", throwable.getClass().getSimpleName()).increment();
    }
}
