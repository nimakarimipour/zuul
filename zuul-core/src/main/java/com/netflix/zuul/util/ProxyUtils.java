...
public class ProxyUtils {
  ...
  static {
    REQ_HEADERS_TO_STRIP.add(
        HttpHeaderNames
            .CONTENT_LENGTH); // Because the httpclient library sets this itself, and doesn't like
    // it if set by us.
  ...
  public static void addXForwardedHeaders(HttpRequestMessage request) {
    ...
    addXForwardedHeader(
        headers, HttpHeaderNames.X_FORWARDED_PORT, Integer.toString(request.getPort()));
