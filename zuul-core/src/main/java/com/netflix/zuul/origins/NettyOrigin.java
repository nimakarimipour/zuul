...
public interface NettyOrigin extends InstrumentedOrigin {
    ...
    Promise<PooledConnection> connectToOrigin(final HttpRequestMessage zuulReq, EventLoop eventLoop, int attemptNumber, @Nullable CurrentPassport passport, AtomicReference<Server> chosenServer, AtomicReference<? super InetAddress> chosenHostAddr);
    ...
    void recordFinalError(final HttpRequestMessage requestMsg, @Nullable final Throwable throwable);
