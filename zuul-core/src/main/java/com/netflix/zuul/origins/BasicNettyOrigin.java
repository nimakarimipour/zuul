...
public class BasicNettyOrigin implements NettyOrigin {
  ...
  public BasicNettyOrigin(OriginName originName, Registry registry) {
    ...
    this.concurrencyMax =
        new CachedDynamicIntProperty(
            "zuul.origin." + niwsClientName + ".concurrency.max.requests", 200);
  ...
  public RequestAttempt newRequestAttempt(
      DiscoveryResult server, SessionContext zuulCtx, int attemptNum) {
  ...
  @Override
  public void onRequestStartWithServer(
