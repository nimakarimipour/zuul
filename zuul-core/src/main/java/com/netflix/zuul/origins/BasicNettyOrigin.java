...
public class BasicNettyOrigin implements NettyOrigin {
    ...
    @Override
    public RequestAttempt newRequestAttempt(@Nullable DiscoveryResult server, SessionContext zuulCtx, int attemptNum) {
    ...
    @Override
    public void onRequestStartWithServer(HttpRequestMessage zuulReq, @Nullable DiscoveryResult discoveryResult, int attemptNum) {
    }

    @Override
    public void onRequestExceptionWithServer(HttpRequestMessage zuulReq, @Nullable DiscoveryResult discoveryResult, int attemptNum, Throwable t) {
    }
    ...
    @Override
    public void onRequestExecutionFailed(HttpRequestMessage zuulReq, @Nullable DiscoveryResult discoveryResult, int attemptNum, Throwable t) {
    }
