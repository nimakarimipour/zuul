...
public class CommonContextKeys {
  ...
  public static final SessionContext.Key<Integer> ORIGIN_STATUS =
      SessionContext.newKey("origin_status");
  ...
  public static final SessionContext.Key<ZuulFilter<HttpRequestMessage, HttpResponseMessage>>
      ZUUL_ENDPOINT = SessionContext.newKey("_zuul_endpoint");
  public static final SessionContext.Key<Map<Integer, InetAddress>>
      ZUUL_ORIGIN_CHOSEN_HOST_ADDR_MAP_KEY =
          SessionContext.newKey("_zuul_origin_chosen_host_addr_map");
  public static final SessionContext.Key<Channel> ORIGIN_CHANNEL =
      SessionContext.newKey("_origin_channel");
  ...
  /**
   * The original client destination address Zuul by a proxy running Proxy Protocol. Will only be
   * set if both Zuul and the connected proxy are both using set to use Proxy Protocol.
   */
  public static final String PROXY_PROTOCOL_DESTINATION_ADDRESS =
      "proxy_protocol_destination_address";
  ...
  public static final String NETTY_SERVER_CHANNEL_HANDLER_CONTEXT =
      "_netty_server_channel_handler_context";
  ...
  public static final SessionContext.Key<CurrentPassport> PASSPORT =
      SessionContext.newKey("_passport");
