 ...
 *
 * <p>Primarily to be used as a performance optimization for avoiding repeatedly doing lower-casing
 * and case-insensitive comparisons of StringS.
 *
 * <p>User: Mike Smith Date: 8/5/15 Time: 12:33 PM
 */
public final class HttpHeaderNames {
  ...
  private static final HttpHeaderNamesCache HEADER_NAME_CACHE =
      new HttpHeaderNamesCache(100, MAX_CACHE_SIZE.get());
  ...
  public static final HeaderName X_FORWARDED_PROTO_VERSION =
      HEADER_NAME_CACHE.get("X-Forwarded-Proto-Version");

  public static final HeaderName ACCESS_CONTROL_ALLOW_ORIGIN =
      HEADER_NAME_CACHE.get("Access-Control-Allow-Origin");
  ...
  public static final HeaderName ACCESS_CONTROL_ALLOW_HEADERS =
      HEADER_NAME_CACHE.get("Access-Control-Allow-Headers");
  public static final HeaderName ACCESS_CONTROL_ALLOW_METHODS =
      HEADER_NAME_CACHE.get("Access-Control-Allow-Methods");
  ...
  public static final HeaderName ACCESS_CONTROL_MAX_AGE_HEADERS =
      HEADER_NAME_CACHE.get("Access-Control-Max-Age");
  public static final HeaderName STRICT_TRANSPORT_SECURITY =
      HEADER_NAME_CACHE.get("Strict-Transport-Security");
  public static final HeaderName LINK = HEADER_NAME_CACHE.get("Link");

  /**
   * Looks up the name in the cache, and if does not exist, then creates and adds a new one (up to
   * the max cache size).
   *
   * @param name
