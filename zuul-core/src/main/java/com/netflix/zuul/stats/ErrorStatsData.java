...
/**
 * Implementation of a Named counter to monitor and count error causes by route. Route is a defined
 * zuul concept to categorize requests into buckets. By default this is the first segment of the uri
 *
 * @author Mikey Cohen Date: 2/23/12 Time: 4:16 PM
 */
