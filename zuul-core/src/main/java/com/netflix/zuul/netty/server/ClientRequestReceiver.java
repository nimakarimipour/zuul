...
public class ClientRequestReceiver extends ChannelDuplexHandler {
    ...
    public ClientRequestReceiver(@Nullable SessionContextDecorator decorator) {
    ...
    public void channelRead(final ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (msg instanceof HttpRequest) {
            ...
            if (clientRequest.decoderResult().isFailure()) {
                LOG.warn("Invalid http request. clientRequest = {} , uri = {}, info = {}", clientRequest.toString(), clientRequest.uri(), ChannelUtils.channelInfoForLogging(ctx.channel()), clientRequest.decoderResult().cause());
