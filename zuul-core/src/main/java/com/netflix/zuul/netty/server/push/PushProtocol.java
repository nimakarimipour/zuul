...
public enum PushProtocol {
  WEBSOCKET {
    @Override
    // The alternative object for HANDSHAKE_COMPLETE is not publicly visible, so disable deprecation
    // warnings.  In
  ...
  public final void sendErrorAndClose(
      ChannelHandlerContext ctx, int statusCode, String reasonText) {
