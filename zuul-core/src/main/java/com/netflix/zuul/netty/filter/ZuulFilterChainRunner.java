...
public class ZuulFilterChainRunner<T extends ZuulMessage> extends BaseZuulFilterRunner<T, T> {
    ...
    public ZuulFilterChainRunner(ZuulFilter<T, T>[] zuulFilters, @Nullable FilterUsageNotifier usageNotifier, @Nullable FilterRunner<T, ?> nextStage) {
        super(zuulFilters[0].filterType(), usageNotifier, nextStage);
        this.filters = zuulFilters;
    }

    public ZuulFilterChainRunner(ZuulFilter<T, T>[] zuulFilters, @Nullable FilterUsageNotifier usageNotifier) {
    ...
    @Override
    protected void resume(@Nullable final T inMesg) {
    ...
    @Override
    public void filter(@Nullable T inMesg, HttpContent chunk) {
        String filterName = "-";
