...
public abstract class BaseZuulFilterRunner<I extends ZuulMessage, O extends ZuulMessage> implements FilterRunner<I, O> {
    ...
    protected BaseZuulFilterRunner(FilterType filterType, @Nullable FilterUsageNotifier usageNotifier, @Nullable FilterRunner<O, ?> nextStage) {
    ...
    protected final AtomicInteger getRunningFilterIndex(@Nullable I zuulMesg) {
    ...
    protected final void invokeNextStage(@Nullable final O zuulMesg, final HttpContent chunk) {
        if (nextStage != null) {
    ...
    protected final void addPerfMarkTags(@Nullable ZuulMessage inMesg) {
    ...
    @Nullable
    protected final O filter(final ZuulFilter<I, O> filter, @Nullable final I inMesg) {
    ...
    protected final boolean shouldSkipFilter(@Nullable final I inMesg, final ZuulFilter<I, O> filter) {
    ...
    protected void recordFilterCompletion(final ExecutionStatus status, final ZuulFilter<I, O> filter, long startTime, final ZuulMessage zuulMesg, @Nullable final ZuulMessage startSnapshot) {
    ...
    protected void handleException(@Nullable final ZuulMessage zuulMesg, @Nullable final String filterName, final Exception ex) {
    ...
    protected abstract void resume(@Nullable O zuulMesg);

    protected MethodBinding<?> methodBinding(@Nullable ZuulMessage zuulMesg) {
        return MethodBinding.NO_OP_BINDING;
    }

    protected void resumeInBindingContext(@Nullable final O zuulMesg, final String filterName) {
        try {
    ...
    private final class FilterChainResumer implements Observer<O> {
        ...
        public FilterChainResumer(I inMesg, ZuulFilter<I, O> filter, @Nullable ZuulMessage snapshot, long startTime) {
