...
public class PassportLoggingHandler extends ChannelInboundHandlerAdapter {
    ...
    private static final CachedDynamicLongProperty WARN_REQ_PROCESSING_TIME_NS = new CachedDynamicLongProperty("zuul.passport.log.request.time.threshold", // 1000 ms
    1000 * 1000 * 1000);

    private static final CachedDynamicLongProperty WARN_RESP_PROCESSING_TIME_NS = new CachedDynamicLongProperty("zuul.passport.log.response.time.threshold", // 1000 ms
    1000 * 1000 * 1000);
