...
public abstract class PushAuthHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
  ...
  public final void sendHttpResponse(
      HttpRequest req, ChannelHandlerContext ctx, HttpResponseStatus status) {
  ...
  /**
   * @return true if Auth credentials will be provided later, for example in first WebSocket frame
   *     sent
   */
