...
public class ZuulEndPointRunner extends BaseZuulFilterRunner<HttpRequestMessage, HttpResponseMessage> {
    ...
    public ZuulEndPointRunner(@Nullable FilterUsageNotifier usageNotifier, @Nullable FilterLoader filterLoader, FilterRunner<HttpResponseMessage, HttpResponseMessage> respFilters) {
        super(FilterType.ENDPOINT, usageNotifier, respFilters);
        this.filterLoader = filterLoader;
    }

    @Nullable
    public static ZuulFilter<HttpRequestMessage, HttpResponseMessage> getEndpoint(@Nullable final HttpRequestMessage zuulReq) {
        if (zuulReq != null) {
    ...
    @Override
    protected void resume(@Nullable final HttpResponseMessage zuulMesg) {
    ...
    @Override
    public void filter(@Nullable final HttpRequestMessage zuulReq, final HttpContent chunk) {
        if (zuulReq.getContext().isCancelled()) {
            chunk.release();
            return;
        }
    ...
    protected ZuulFilter<HttpRequestMessage, HttpResponseMessage> getEndpoint(@Nullable final String endpointName, final HttpRequestMessage zuulRequest) {
