...
public interface ClientChannelManager {
    ...
    Promise<PooledConnection> acquire(EventLoop eventLoop, @Nullable Object key, CurrentPassport passport, AtomicReference<DiscoveryResult> selectedServer, AtomicReference<? super InetAddress> selectedHostAddr);
